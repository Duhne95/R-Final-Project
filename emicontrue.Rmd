---
title: "Consumption Fossils Comparison by Continent"
...
The raw data for this project was obtained from Integrated Carbon Observation System on November 29, 2024, and covers one-year periods from 1990 to 2020. The data includes the year, country and fossil emissions, in order to facilitate observations only the data from the tab Consumption Emissions was utilized.

It is important to note that all consumption emission values are in million tonnes of carbon per year.

The link of the data set can be found below.

## Data Source
If you are going into the Integrated Carbon Observation System main webpage you must click on the following tabs:
Science & Impact< Global Carbon Budget< Global Carbon Budgget 2022<View the Global Carbon Budget 2022 here< 2022 National Fossil Carbon Emissions 2022 v.1.0

https://www.icos-cp.eu/science-and-impact/global-carbon-budget/2022

## Background
Consumption emission gases are those that are produced when there is usage of combustion fuel sources, such as the gases expelled by cars.

Due to the human industrialization advancements there has been a heavy reliance on combustion fuel that impacts the greenhouse effect of the Earth. 

This, consequently influences other aspects of Earth, for example the rising temperatures, sea levels rising, the proliferation of forest fires, among others.

## Research Question

**The quantity of consumption emission has skyrocketed from 1990 to 2020?**

The visualization aims to examine the consumption CO₂ emissions over a 30-year period. It is hypothesized that these emissions will have increasingly noticeable changes as time progresses due to an extreme dependence on fossil fuel combustion.
...
## Add color by country, transparency, adjust line width, tittle, subtittle and caption
```{r warning = FALSE}
